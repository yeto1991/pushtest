						...
						<tr>
							<td>条件1：
								<select name="summary_key1" id="summary_key1">
									...
									<option value="26" {if ('26' == $form.summary_key1)}selected{/if}>業種大分類(1)</option>
									<option value="27" {if ('27' == $form.summary_key1)}selected{/if}>業種小分類(1)</option>
									<option value="28" {if ('28' == $form.summary_key1)}selected{/if}>業種大分類(2)</option>
									<option value="29" {if ('29' == $form.summary_key1)}selected{/if}>業種小分類(2)</option>
									<option value="30" {if ('30' == $form.summary_key1)}selected{/if}>業種大分類(3)</option>
									<option value="31" {if ('31' == $form.summary_key1)}selected{/if}>業種小分類(3)</option>
									<option value="32" {if ('32' == $form.summary_key1)}selected{/if}>業種大分類(4)</option>
									<option value="33" {if ('33' == $form.summary_key1)}selected{/if}>業種小分類(4)</option>
									<option value="34" {if ('34' == $form.summary_key1)}selected{/if}>業種大分類(5)</option>
									<option value="35" {if ('35' == $form.summary_key1)}selected{/if}>業種小分類(5)</option>
									<option value="36" {if ('36' == $form.summary_key1)}selected{/if}>業種大分類(6)</option>
									<option value="37" {if ('37' == $form.summary_key1)}selected{/if}>業種小分類(6)</option>
									<option value="38" {if ('38' == $form.summary_key1)}selected{/if}>出品物(日)</option>
									<option value="39" {if ('39' == $form.summary_key1)}selected{/if}>出品物(英)</option>
									<option value="40" {if ('40' == $form.summary_key1)}selected{/if}>開催地地域</option>
									<option value="41" {if ('41' == $form.summary_key1)}selected{/if}>開催地国地域</option>
									<option value="42" {if ('42' == $form.summary_key1)}selected{/if}>開催地都市</option>
									<option value="43" {if ('43' == $form.summary_key1)}selected{/if}>開催地その他(日)</option>
									<option value="44" {if ('44' == $form.summary_key1)}selected{/if}>開催地その他(英)</option>
									<option value="45" {if ('45' == $form.summary_key1)}selected{/if}>会場名(日)</option>
									<option value="46" {if ('46' == $form.summary_key1)}selected{/if}>会場名(英)</option>
									<option value="47" {if ('47' == $form.summary_key1)}selected{/if}>開催予定規模</option>
									<option value="48" {if ('48' == $form.summary_key1)}selected{/if}>入場資格</option>
									<option value="49" {if ('49' == $form.summary_key1)}selected{/if}>チケットの入手方法(1)</option>
									<option value="50" {if ('50' == $form.summary_key1)}selected{/if}>チケットの入手方法(2)</option>
									<option value="51" {if ('51' == $form.summary_key1)}selected{/if}>チケットの入手方法(3)</option>
									<option value="52" {if ('52' == $form.summary_key1)}selected{/if}>チケットの入手方法(4)</option>
									<option value="53" {if ('53' == $form.summary_key1)}selected{/if}>チケットの入手方法その他(日)</option>
									<option value="54" {if ('54' == $form.summary_key1)}selected{/if}>チケットの入手方法Others(英)</option>
									<option value="55" {if ('55' == $form.summary_key1)}selected{/if}>過去の実績年実績</option>
									<option value="56" {if ('56' == $form.summary_key1)}selected{/if}>過去の実績来場者数</option>
									<option value="57" {if ('57' == $form.summary_key1)}selected{/if}>過去の実績海外来場者数</option>
									<option value="58" {if ('58' == $form.summary_key1)}selected{/if}>過去の実績出展社数</option>
									<option value="59" {if ('59' == $form.summary_key1)}selected{/if}>過去の実績海外出展社数</option>
									<option value="60" {if ('60' == $form.summary_key1)}selected{/if}>過去の実績開催規模</option>
									<option value="61" {if ('61' == $form.summary_key1)}selected{/if}>過去の実績認証機関</option>
									<option value="62" {if ('62' == $form.summary_key1)}selected{/if}>主催者・問合せ先名称(日)</option>
									<option value="63" {if ('63' == $form.summary_key1)}selected{/if}>主催者・問合せ先名称(英)</option>
									<option value="64" {if ('64' == $form.summary_key1)}selected{/if}>主催者・問合せ先TEL</option>
									<option value="65" {if ('65' == $form.summary_key1)}selected{/if}>主催者・問合せ先FAX</option>
									<option value="66" {if ('66' == $form.summary_key1)}selected{/if}>主催者・問合せ先Email</option>
									<option value="67" {if ('67' == $form.summary_key1)}selected{/if}>主催者・問合せ先住所</option>
									<option value="68" {if ('68' == $form.summary_key1)}selected{/if}>主催者・問合せ先担当部課</option>
									<option value="69" {if ('69' == $form.summary_key1)}selected{/if}>主催者・問合せ先担当者</option>
									<option value="70" {if ('70' == $form.summary_key1)}selected{/if}>日本国内の照会先名称(日)</option>
									<option value="71" {if ('71' == $form.summary_key1)}selected{/if}>日本国内の照会先名称(英)</option>
									<option value="72" {if ('72' == $form.summary_key1)}selected{/if}>日本国内の照会先TEL</option>
									<option value="73" {if ('73' == $form.summary_key1)}selected{/if}>日本国内の照会先FAX</option>
									<option value="74" {if ('74' == $form.summary_key1)}selected{/if}>日本国内の照会先Email</option>
									<option value="75" {if ('75' == $form.summary_key1)}selected{/if}>日本国内の照会先住所</option>
									<option value="76" {if ('76' == $form.summary_key1)}selected{/if}>日本国内の照会先担当部課</option>
									<option value="77" {if ('77' == $form.summary_key1)}selected{/if}>日本国内の照会先担当者</option>
									<option value="78" {if ('78' == $form.summary_key1)}selected{/if}>見本市レポートURL</option>
									<option value="79" {if ('79' == $form.summary_key1)}selected{/if}>世界の展示会場URL</option>
									<option value="80" {if ('80' == $form.summary_key1)}selected{/if}>展示会に係わる画像名称1</option>
									<option value="81" {if ('81' == $form.summary_key1)}selected{/if}>展示会に係わる画像名称2</option>
									<option value="82" {if ('82' == $form.summary_key1)}selected{/if}>展示会に係わる画像名称3</option>
									<option value="83" {if ('83' == $form.summary_key1)}selected{/if}>システム管理者備考欄</option>
									<option value="84" {if ('84' == $form.summary_key1)}selected{/if}>データ管理者備考欄</option>
									<option value="85" {if ('85' == $form.summary_key1)}selected{/if}>削除フラグ</option>
									<option value="86" {if ('86' == $form.summary_key1)}selected{/if}>登録者ID</option>
									<option value="87" {if ('87' == $form.summary_key1)}selected{/if}>更新者ID</option>
								</select>
							</td>
							<td>
						...
						<tr>
							<td>条件2：
								<select name="summary_key2" id="summary_key2">
									...
									<option value="26" {if ('26' == $form.summary_key2)}selected{/if}>業種大分類(1)</option>
									<option value="27" {if ('27' == $form.summary_key2)}selected{/if}>業種小分類(1)</option>
									<option value="28" {if ('28' == $form.summary_key2)}selected{/if}>業種大分類(2)</option>
									<option value="29" {if ('29' == $form.summary_key2)}selected{/if}>業種小分類(2)</option>
									<option value="30" {if ('30' == $form.summary_key2)}selected{/if}>業種大分類(3)</option>
									<option value="31" {if ('31' == $form.summary_key2)}selected{/if}>業種小分類(3)</option>
									<option value="32" {if ('32' == $form.summary_key2)}selected{/if}>業種大分類(4)</option>
									<option value="33" {if ('33' == $form.summary_key2)}selected{/if}>業種小分類(4)</option>
									<option value="34" {if ('34' == $form.summary_key2)}selected{/if}>業種大分類(5)</option>
									<option value="35" {if ('35' == $form.summary_key2)}selected{/if}>業種小分類(5)</option>
									<option value="36" {if ('36' == $form.summary_key2)}selected{/if}>業種大分類(6)</option>
									<option value="37" {if ('37' == $form.summary_key2)}selected{/if}>業種小分類(6)</option>
									<option value="38" {if ('38' == $form.summary_key2)}selected{/if}>出品物(日)</option>
									<option value="39" {if ('39' == $form.summary_key2)}selected{/if}>出品物(英)</option>
									<option value="40" {if ('40' == $form.summary_key2)}selected{/if}>開催地地域</option>
									<option value="41" {if ('41' == $form.summary_key2)}selected{/if}>開催地国地域</option>
									<option value="42" {if ('42' == $form.summary_key2)}selected{/if}>開催地都市</option>
									<option value="43" {if ('43' == $form.summary_key2)}selected{/if}>開催地その他(日)</option>
									<option value="44" {if ('44' == $form.summary_key2)}selected{/if}>開催地その他(英)</option>
									<option value="45" {if ('45' == $form.summary_key2)}selected{/if}>会場名(日)</option>
									<option value="46" {if ('46' == $form.summary_key2)}selected{/if}>会場名(英)</option>
									<option value="47" {if ('47' == $form.summary_key2)}selected{/if}>開催予定規模</option>
									<option value="48" {if ('48' == $form.summary_key2)}selected{/if}>入場資格</option>
									<option value="49" {if ('49' == $form.summary_key2)}selected{/if}>チケットの入手方法(1)</option>
									<option value="50" {if ('50' == $form.summary_key2)}selected{/if}>チケットの入手方法(2)</option>
									<option value="51" {if ('51' == $form.summary_key2)}selected{/if}>チケットの入手方法(3)</option>
									<option value="52" {if ('52' == $form.summary_key2)}selected{/if}>チケットの入手方法(4)</option>
									<option value="53" {if ('53' == $form.summary_key2)}selected{/if}>チケットの入手方法その他(日)</option>
									<option value="54" {if ('54' == $form.summary_key2)}selected{/if}>チケットの入手方法Others(英)</option>
									<option value="55" {if ('55' == $form.summary_key2)}selected{/if}>過去の実績年実績</option>
									<option value="56" {if ('56' == $form.summary_key2)}selected{/if}>過去の実績来場者数</option>
									<option value="57" {if ('57' == $form.summary_key2)}selected{/if}>過去の実績海外来場者数</option>
									<option value="58" {if ('58' == $form.summary_key2)}selected{/if}>過去の実績出展社数</option>
									<option value="59" {if ('59' == $form.summary_key2)}selected{/if}>過去の実績海外出展社数</option>
									<option value="60" {if ('60' == $form.summary_key2)}selected{/if}>過去の実績開催規模</option>
									<option value="61" {if ('61' == $form.summary_key2)}selected{/if}>過去の実績認証機関</option>
									<option value="62" {if ('62' == $form.summary_key2)}selected{/if}>主催者・問合せ先名称(日)</option>
									<option value="63" {if ('63' == $form.summary_key2)}selected{/if}>主催者・問合せ先名称(英)</option>
									<option value="64" {if ('64' == $form.summary_key2)}selected{/if}>主催者・問合せ先TEL</option>
									<option value="65" {if ('65' == $form.summary_key2)}selected{/if}>主催者・問合せ先FAX</option>
									<option value="66" {if ('66' == $form.summary_key2)}selected{/if}>主催者・問合せ先Email</option>
									<option value="67" {if ('67' == $form.summary_key2)}selected{/if}>主催者・問合せ先住所</option>
									<option value="68" {if ('68' == $form.summary_key2)}selected{/if}>主催者・問合せ先担当部課</option>
									<option value="69" {if ('69' == $form.summary_key2)}selected{/if}>主催者・問合せ先担当者</option>
									<option value="70" {if ('70' == $form.summary_key2)}selected{/if}>日本国内の照会先名称(日)</option>
									<option value="71" {if ('71' == $form.summary_key2)}selected{/if}>日本国内の照会先名称(英)</option>
									<option value="72" {if ('72' == $form.summary_key2)}selected{/if}>日本国内の照会先TEL</option>
									<option value="73" {if ('73' == $form.summary_key2)}selected{/if}>日本国内の照会先FAX</option>
									<option value="74" {if ('74' == $form.summary_key2)}selected{/if}>日本国内の照会先Email</option>
									<option value="75" {if ('75' == $form.summary_key2)}selected{/if}>日本国内の照会先住所</option>
									<option value="76" {if ('76' == $form.summary_key2)}selected{/if}>日本国内の照会先担当部課</option>
									<option value="77" {if ('77' == $form.summary_key2)}selected{/if}>日本国内の照会先担当者</option>
									<option value="78" {if ('78' == $form.summary_key2)}selected{/if}>見本市レポートURL</option>
									<option value="79" {if ('79' == $form.summary_key2)}selected{/if}>世界の展示会場URL</option>
									<option value="80" {if ('80' == $form.summary_key2)}selected{/if}>展示会に係わる画像名称1</option>
									<option value="81" {if ('81' == $form.summary_key2)}selected{/if}>展示会に係わる画像名称2</option>
									<option value="82" {if ('82' == $form.summary_key2)}selected{/if}>展示会に係わる画像名称3</option>
									<option value="83" {if ('83' == $form.summary_key2)}selected{/if}>システム管理者備考欄</option>
									<option value="84" {if ('84' == $form.summary_key2)}selected{/if}>データ管理者備考欄</option>
									<option value="85" {if ('85' == $form.summary_key2)}selected{/if}>削除フラグ</option>
									<option value="86" {if ('86' == $form.summary_key2)}selected{/if}>登録者ID</option>
									<option value="87" {if ('87' == $form.summary_key2)}selected{/if}>更新者ID</option>
								</select>
							</td>
							<td>
						...
						<tr>
							<td>条件3：
								<select name="summary_key3" id="summary_key3">
									...
									<option value="26" {if ('26' == $form.summary_key3)}selected{/if}>業種大分類(1)</option>
									<option value="27" {if ('27' == $form.summary_key3)}selected{/if}>業種小分類(1)</option>
									<option value="28" {if ('28' == $form.summary_key3)}selected{/if}>業種大分類(2)</option>
									<option value="29" {if ('29' == $form.summary_key3)}selected{/if}>業種小分類(2)</option>
									<option value="30" {if ('30' == $form.summary_key3)}selected{/if}>業種大分類(3)</option>
									<option value="31" {if ('31' == $form.summary_key3)}selected{/if}>業種小分類(3)</option>
									<option value="32" {if ('32' == $form.summary_key3)}selected{/if}>業種大分類(4)</option>
									<option value="33" {if ('33' == $form.summary_key3)}selected{/if}>業種小分類(4)</option>
									<option value="34" {if ('34' == $form.summary_key3)}selected{/if}>業種大分類(5)</option>
									<option value="35" {if ('35' == $form.summary_key3)}selected{/if}>業種小分類(5)</option>
									<option value="36" {if ('36' == $form.summary_key3)}selected{/if}>業種大分類(6)</option>
									<option value="37" {if ('37' == $form.summary_key3)}selected{/if}>業種小分類(6)</option>
									<option value="38" {if ('38' == $form.summary_key3)}selected{/if}>出品物(日)</option>
									<option value="39" {if ('39' == $form.summary_key3)}selected{/if}>出品物(英)</option>
									<option value="40" {if ('40' == $form.summary_key3)}selected{/if}>開催地地域</option>
									<option value="41" {if ('41' == $form.summary_key3)}selected{/if}>開催地国地域</option>
									<option value="42" {if ('42' == $form.summary_key3)}selected{/if}>開催地都市</option>
									<option value="43" {if ('43' == $form.summary_key3)}selected{/if}>開催地その他(日)</option>
									<option value="44" {if ('44' == $form.summary_key3)}selected{/if}>開催地その他(英)</option>
									<option value="45" {if ('45' == $form.summary_key3)}selected{/if}>会場名(日)</option>
									<option value="46" {if ('46' == $form.summary_key3)}selected{/if}>会場名(英)</option>
									<option value="47" {if ('47' == $form.summary_key3)}selected{/if}>開催予定規模</option>
									<option value="48" {if ('48' == $form.summary_key3)}selected{/if}>入場資格</option>
									<option value="49" {if ('49' == $form.summary_key3)}selected{/if}>チケットの入手方法(1)</option>
									<option value="50" {if ('50' == $form.summary_key3)}selected{/if}>チケットの入手方法(2)</option>
									<option value="51" {if ('51' == $form.summary_key3)}selected{/if}>チケットの入手方法(3)</option>
									<option value="52" {if ('52' == $form.summary_key3)}selected{/if}>チケットの入手方法(4)</option>
									<option value="53" {if ('53' == $form.summary_key3)}selected{/if}>チケットの入手方法その他(日)</option>
									<option value="54" {if ('54' == $form.summary_key3)}selected{/if}>チケットの入手方法Others(英)</option>
									<option value="55" {if ('55' == $form.summary_key3)}selected{/if}>過去の実績年実績</option>
									<option value="56" {if ('56' == $form.summary_key3)}selected{/if}>過去の実績来場者数</option>
									<option value="57" {if ('57' == $form.summary_key3)}selected{/if}>過去の実績海外来場者数</option>
									<option value="58" {if ('58' == $form.summary_key3)}selected{/if}>過去の実績出展社数</option>
									<option value="59" {if ('59' == $form.summary_key3)}selected{/if}>過去の実績海外出展社数</option>
									<option value="60" {if ('60' == $form.summary_key3)}selected{/if}>過去の実績開催規模</option>
									<option value="61" {if ('61' == $form.summary_key3)}selected{/if}>過去の実績認証機関</option>
									<option value="62" {if ('62' == $form.summary_key3)}selected{/if}>主催者・問合せ先名称(日)</option>
									<option value="63" {if ('63' == $form.summary_key3)}selected{/if}>主催者・問合せ先名称(英)</option>
									<option value="64" {if ('64' == $form.summary_key3)}selected{/if}>主催者・問合せ先TEL</option>
									<option value="65" {if ('65' == $form.summary_key3)}selected{/if}>主催者・問合せ先FAX</option>
									<option value="66" {if ('66' == $form.summary_key3)}selected{/if}>主催者・問合せ先Email</option>
									<option value="67" {if ('67' == $form.summary_key3)}selected{/if}>主催者・問合せ先住所</option>
									<option value="68" {if ('68' == $form.summary_key3)}selected{/if}>主催者・問合せ先担当部課</option>
									<option value="69" {if ('69' == $form.summary_key3)}selected{/if}>主催者・問合せ先担当者</option>
									<option value="70" {if ('70' == $form.summary_key3)}selected{/if}>日本国内の照会先名称(日)</option>
									<option value="71" {if ('71' == $form.summary_key3)}selected{/if}>日本国内の照会先名称(英)</option>
									<option value="72" {if ('72' == $form.summary_key3)}selected{/if}>日本国内の照会先TEL</option>
									<option value="73" {if ('73' == $form.summary_key3)}selected{/if}>日本国内の照会先FAX</option>
									<option value="74" {if ('74' == $form.summary_key3)}selected{/if}>日本国内の照会先Email</option>
									<option value="75" {if ('75' == $form.summary_key3)}selected{/if}>日本国内の照会先住所</option>
									<option value="76" {if ('76' == $form.summary_key3)}selected{/if}>日本国内の照会先担当部課</option>
									<option value="77" {if ('77' == $form.summary_key3)}selected{/if}>日本国内の照会先担当者</option>
									<option value="78" {if ('78' == $form.summary_key3)}selected{/if}>見本市レポートURL</option>
									<option value="79" {if ('79' == $form.summary_key3)}selected{/if}>世界の展示会場URL</option>
									<option value="80" {if ('80' == $form.summary_key3)}selected{/if}>展示会に係わる画像名称1</option>
									<option value="81" {if ('81' == $form.summary_key3)}selected{/if}>展示会に係わる画像名称2</option>
									<option value="82" {if ('82' == $form.summary_key3)}selected{/if}>展示会に係わる画像名称3</option>
									<option value="83" {if ('83' == $form.summary_key3)}selected{/if}>システム管理者備考欄</option>
									<option value="84" {if ('84' == $form.summary_key3)}selected{/if}>データ管理者備考欄</option>
									<option value="85" {if ('85' == $form.summary_key3)}selected{/if}>削除フラグ</option>
									<option value="86" {if ('86' == $form.summary_key3)}selected{/if}>登録者ID</option>
									<option value="87" {if ('87' == $form.summary_key3)}selected{/if}>更新者ID</option>
								</select>
							</td>
							<td>
						...
						<tr>
							<td>条件4：
								<select name="summary_key4" id="summary_key4">
									...
									<option value="26" {if ('26' == $form.summary_key4)}selected{/if}>業種大分類(1)</option>
									<option value="27" {if ('27' == $form.summary_key4)}selected{/if}>業種小分類(1)</option>
									<option value="28" {if ('28' == $form.summary_key4)}selected{/if}>業種大分類(2)</option>
									<option value="29" {if ('29' == $form.summary_key4)}selected{/if}>業種小分類(2)</option>
									<option value="30" {if ('30' == $form.summary_key4)}selected{/if}>業種大分類(3)</option>
									<option value="31" {if ('31' == $form.summary_key4)}selected{/if}>業種小分類(3)</option>
									<option value="32" {if ('32' == $form.summary_key4)}selected{/if}>業種大分類(4)</option>
									<option value="33" {if ('33' == $form.summary_key4)}selected{/if}>業種小分類(4)</option>
									<option value="34" {if ('34' == $form.summary_key4)}selected{/if}>業種大分類(5)</option>
									<option value="35" {if ('35' == $form.summary_key4)}selected{/if}>業種小分類(5)</option>
									<option value="36" {if ('36' == $form.summary_key4)}selected{/if}>業種大分類(6)</option>
									<option value="37" {if ('37' == $form.summary_key4)}selected{/if}>業種小分類(6)</option>
									<option value="38" {if ('38' == $form.summary_key4)}selected{/if}>出品物(日)</option>
									<option value="39" {if ('39' == $form.summary_key4)}selected{/if}>出品物(英)</option>
									<option value="40" {if ('40' == $form.summary_key4)}selected{/if}>開催地地域</option>
									<option value="41" {if ('41' == $form.summary_key4)}selected{/if}>開催地国地域</option>
									<option value="42" {if ('42' == $form.summary_key4)}selected{/if}>開催地都市</option>
									<option value="43" {if ('43' == $form.summary_key4)}selected{/if}>開催地その他(日)</option>
									<option value="44" {if ('44' == $form.summary_key4)}selected{/if}>開催地その他(英)</option>
									<option value="45" {if ('45' == $form.summary_key4)}selected{/if}>会場名(日)</option>
									<option value="46" {if ('46' == $form.summary_key4)}selected{/if}>会場名(英)</option>
									<option value="47" {if ('47' == $form.summary_key4)}selected{/if}>開催予定規模</option>
									<option value="48" {if ('48' == $form.summary_key4)}selected{/if}>入場資格</option>
									<option value="49" {if ('49' == $form.summary_key4)}selected{/if}>チケットの入手方法(1)</option>
									<option value="50" {if ('50' == $form.summary_key4)}selected{/if}>チケットの入手方法(2)</option>
									<option value="51" {if ('51' == $form.summary_key4)}selected{/if}>チケットの入手方法(3)</option>
									<option value="52" {if ('52' == $form.summary_key4)}selected{/if}>チケットの入手方法(4)</option>
									<option value="53" {if ('53' == $form.summary_key4)}selected{/if}>チケットの入手方法その他(日)</option>
									<option value="54" {if ('54' == $form.summary_key4)}selected{/if}>チケットの入手方法Others(英)</option>
									<option value="55" {if ('55' == $form.summary_key4)}selected{/if}>過去の実績年実績</option>
									<option value="56" {if ('56' == $form.summary_key4)}selected{/if}>過去の実績来場者数</option>
									<option value="57" {if ('57' == $form.summary_key4)}selected{/if}>過去の実績海外来場者数</option>
									<option value="58" {if ('58' == $form.summary_key4)}selected{/if}>過去の実績出展社数</option>
									<option value="59" {if ('59' == $form.summary_key4)}selected{/if}>過去の実績海外出展社数</option>
									<option value="60" {if ('60' == $form.summary_key4)}selected{/if}>過去の実績開催規模</option>
									<option value="61" {if ('61' == $form.summary_key4)}selected{/if}>過去の実績認証機関</option>
									<option value="62" {if ('62' == $form.summary_key4)}selected{/if}>主催者・問合せ先名称(日)</option>
									<option value="63" {if ('63' == $form.summary_key4)}selected{/if}>主催者・問合せ先名称(英)</option>
									<option value="64" {if ('64' == $form.summary_key4)}selected{/if}>主催者・問合せ先TEL</option>
									<option value="65" {if ('65' == $form.summary_key4)}selected{/if}>主催者・問合せ先FAX</option>
									<option value="66" {if ('66' == $form.summary_key4)}selected{/if}>主催者・問合せ先Email</option>
									<option value="67" {if ('67' == $form.summary_key4)}selected{/if}>主催者・問合せ先住所</option>
									<option value="68" {if ('68' == $form.summary_key4)}selected{/if}>主催者・問合せ先担当部課</option>
									<option value="69" {if ('69' == $form.summary_key4)}selected{/if}>主催者・問合せ先担当者</option>
									<option value="70" {if ('70' == $form.summary_key4)}selected{/if}>日本国内の照会先名称(日)</option>
									<option value="71" {if ('71' == $form.summary_key4)}selected{/if}>日本国内の照会先名称(英)</option>
									<option value="72" {if ('72' == $form.summary_key4)}selected{/if}>日本国内の照会先TEL</option>
									<option value="73" {if ('73' == $form.summary_key4)}selected{/if}>日本国内の照会先FAX</option>
									<option value="74" {if ('74' == $form.summary_key4)}selected{/if}>日本国内の照会先Email</option>
									<option value="75" {if ('75' == $form.summary_key4)}selected{/if}>日本国内の照会先住所</option>
									<option value="76" {if ('76' == $form.summary_key4)}selected{/if}>日本国内の照会先担当部課</option>
									<option value="77" {if ('77' == $form.summary_key4)}selected{/if}>日本国内の照会先担当者</option>
									<option value="78" {if ('78' == $form.summary_key4)}selected{/if}>見本市レポートURL</option>
									<option value="79" {if ('79' == $form.summary_key4)}selected{/if}>世界の展示会場URL</option>
									<option value="80" {if ('80' == $form.summary_key4)}selected{/if}>展示会に係わる画像名称1</option>
									<option value="81" {if ('81' == $form.summary_key4)}selected{/if}>展示会に係わる画像名称2</option>
									<option value="82" {if ('82' == $form.summary_key4)}selected{/if}>展示会に係わる画像名称3</option>
									<option value="83" {if ('83' == $form.summary_key4)}selected{/if}>システム管理者備考欄</option>
									<option value="84" {if ('84' == $form.summary_key4)}selected{/if}>データ管理者備考欄</option>
									<option value="85" {if ('85' == $form.summary_key4)}selected{/if}>削除フラグ</option>
									<option value="86" {if ('86' == $form.summary_key4)}selected{/if}>登録者ID</option>
									<option value="87" {if ('87' == $form.summary_key4)}selected{/if}>更新者ID</option>
								</select>
							</td>
							<td>
						...
						<tr>
							<td>条件5：
								<select name="summary_key5" id="summary_key5">
									...
									<option value="26" {if ('26' == $form.summary_key5)}selected{/if}>業種大分類(1)</option>
									<option value="27" {if ('27' == $form.summary_key5)}selected{/if}>業種小分類(1)</option>
									<option value="28" {if ('28' == $form.summary_key5)}selected{/if}>業種大分類(2)</option>
									<option value="29" {if ('29' == $form.summary_key5)}selected{/if}>業種小分類(2)</option>
									<option value="30" {if ('30' == $form.summary_key5)}selected{/if}>業種大分類(3)</option>
									<option value="31" {if ('31' == $form.summary_key5)}selected{/if}>業種小分類(3)</option>
									<option value="32" {if ('32' == $form.summary_key5)}selected{/if}>業種大分類(4)</option>
									<option value="33" {if ('33' == $form.summary_key5)}selected{/if}>業種小分類(4)</option>
									<option value="34" {if ('34' == $form.summary_key5)}selected{/if}>業種大分類(5)</option>
									<option value="35" {if ('35' == $form.summary_key5)}selected{/if}>業種小分類(5)</option>
									<option value="36" {if ('36' == $form.summary_key5)}selected{/if}>業種大分類(6)</option>
									<option value="37" {if ('37' == $form.summary_key5)}selected{/if}>業種小分類(6)</option>
									<option value="38" {if ('38' == $form.summary_key5)}selected{/if}>出品物(日)</option>
									<option value="39" {if ('39' == $form.summary_key5)}selected{/if}>出品物(英)</option>
									<option value="40" {if ('40' == $form.summary_key5)}selected{/if}>開催地地域</option>
									<option value="41" {if ('41' == $form.summary_key5)}selected{/if}>開催地国地域</option>
									<option value="42" {if ('42' == $form.summary_key5)}selected{/if}>開催地都市</option>
									<option value="43" {if ('43' == $form.summary_key5)}selected{/if}>開催地その他(日)</option>
									<option value="44" {if ('44' == $form.summary_key5)}selected{/if}>開催地その他(英)</option>
									<option value="45" {if ('45' == $form.summary_key5)}selected{/if}>会場名(日)</option>
									<option value="46" {if ('46' == $form.summary_key5)}selected{/if}>会場名(英)</option>
									<option value="47" {if ('47' == $form.summary_key5)}selected{/if}>開催予定規模</option>
									<option value="48" {if ('48' == $form.summary_key5)}selected{/if}>入場資格</option>
									<option value="49" {if ('49' == $form.summary_key5)}selected{/if}>チケットの入手方法(1)</option>
									<option value="50" {if ('50' == $form.summary_key5)}selected{/if}>チケットの入手方法(2)</option>
									<option value="51" {if ('51' == $form.summary_key5)}selected{/if}>チケットの入手方法(3)</option>
									<option value="52" {if ('52' == $form.summary_key5)}selected{/if}>チケットの入手方法(4)</option>
									<option value="53" {if ('53' == $form.summary_key5)}selected{/if}>チケットの入手方法その他(日)</option>
									<option value="54" {if ('54' == $form.summary_key5)}selected{/if}>チケットの入手方法Others(英)</option>
									<option value="55" {if ('55' == $form.summary_key5)}selected{/if}>過去の実績年実績</option>
									<option value="56" {if ('56' == $form.summary_key5)}selected{/if}>過去の実績来場者数</option>
									<option value="57" {if ('57' == $form.summary_key5)}selected{/if}>過去の実績海外来場者数</option>
									<option value="58" {if ('58' == $form.summary_key5)}selected{/if}>過去の実績出展社数</option>
									<option value="59" {if ('59' == $form.summary_key5)}selected{/if}>過去の実績海外出展社数</option>
									<option value="60" {if ('60' == $form.summary_key5)}selected{/if}>過去の実績開催規模</option>
									<option value="61" {if ('61' == $form.summary_key5)}selected{/if}>過去の実績認証機関</option>
									<option value="62" {if ('62' == $form.summary_key5)}selected{/if}>主催者・問合せ先名称(日)</option>
									<option value="63" {if ('63' == $form.summary_key5)}selected{/if}>主催者・問合せ先名称(英)</option>
									<option value="64" {if ('64' == $form.summary_key5)}selected{/if}>主催者・問合せ先TEL</option>
									<option value="65" {if ('65' == $form.summary_key5)}selected{/if}>主催者・問合せ先FAX</option>
									<option value="66" {if ('66' == $form.summary_key5)}selected{/if}>主催者・問合せ先Email</option>
									<option value="67" {if ('67' == $form.summary_key5)}selected{/if}>主催者・問合せ先住所</option>
									<option value="68" {if ('68' == $form.summary_key5)}selected{/if}>主催者・問合せ先担当部課</option>
									<option value="69" {if ('69' == $form.summary_key5)}selected{/if}>主催者・問合せ先担当者</option>
									<option value="70" {if ('70' == $form.summary_key5)}selected{/if}>日本国内の照会先名称(日)</option>
									<option value="71" {if ('71' == $form.summary_key5)}selected{/if}>日本国内の照会先名称(英)</option>
									<option value="72" {if ('72' == $form.summary_key5)}selected{/if}>日本国内の照会先TEL</option>
									<option value="73" {if ('73' == $form.summary_key5)}selected{/if}>日本国内の照会先FAX</option>
									<option value="74" {if ('74' == $form.summary_key5)}selected{/if}>日本国内の照会先Email</option>
									<option value="75" {if ('75' == $form.summary_key5)}selected{/if}>日本国内の照会先住所</option>
									<option value="76" {if ('76' == $form.summary_key5)}selected{/if}>日本国内の照会先担当部課</option>
									<option value="77" {if ('77' == $form.summary_key5)}selected{/if}>日本国内の照会先担当者</option>
									<option value="78" {if ('78' == $form.summary_key5)}selected{/if}>見本市レポートURL</option>
									<option value="79" {if ('79' == $form.summary_key5)}selected{/if}>世界の展示会場URL</option>
									<option value="80" {if ('80' == $form.summary_key5)}selected{/if}>展示会に係わる画像名称1</option>
									<option value="81" {if ('81' == $form.summary_key5)}selected{/if}>展示会に係わる画像名称2</option>
									<option value="82" {if ('82' == $form.summary_key5)}selected{/if}>展示会に係わる画像名称3</option>
									<option value="83" {if ('83' == $form.summary_key5)}selected{/if}>システム管理者備考欄</option>
									<option value="84" {if ('84' == $form.summary_key5)}selected{/if}>データ管理者備考欄</option>
									<option value="85" {if ('85' == $form.summary_key5)}selected{/if}>削除フラグ</option>
									<option value="86" {if ('86' == $form.summary_key5)}selected{/if}>登録者ID</option>
									<option value="87" {if ('87' == $form.summary_key5)}selected{/if}>更新者ID</option>
								</select>
							</td>
							<td>
						...
						<tr>
							<td>
								<select name="summary_value" id="summary_value">
									...
									<option value="88" {if ('88' == $form.summary_value)}selected{/if}>削除日時</option>
									<option value="89" {if ('89' == $form.summary_value)}selected{/if}>登録日</option>
									<option value="90" {if ('90' == $form.summary_value)}selected{/if}>更新日</option>
								</select>
							</td>
							<td>
