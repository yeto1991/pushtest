		...
		<div id="main">
			...
			<div class="in_main" style="word-break: break-all;">
				...
				{if ('' != $app.fair_detail.fair_url)}
					<a class="icon_arrow" target="_blank" style="float:left;" href="{$app.fair_detail.fair_url}"><b><font size="2">official site</font></b></a>
					<img class="icon_external" style="float:left;" src="/images/jp/icon-external.gif">
				{/if}
				<p class="t_right">
