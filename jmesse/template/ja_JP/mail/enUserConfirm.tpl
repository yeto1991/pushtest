Notice of reissue of your password for J-messe

Dear Mr. /Ms. {$mail_send_user_name},

Thank you for using J-messe.
This email informs you of your password reissued upon your request as follows:

	Reissued password: {$mail_send_user_password}
