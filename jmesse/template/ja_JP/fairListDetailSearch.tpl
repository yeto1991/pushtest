...
<title>見本市・展示会データベース（J-messe） - ジェトロ</title>
</head>
<body class="layout-LC highlight-match">
	<!-- header -->
	{$app_ne.header}
	<!-- /header -->
	<!-- bread -->
					...
					<div class="bgbox_set">
						<div class="bgbox_base">
							<div class="h1 clearfix">
								...
								<a href="/en/database/j-messe/" class="english"><img src="./images/btn_english.gif" alt="English" width="68" height="17" class="over" /></a>
							</div>
							<p class="margin_ltrb00">
								<img width="778" height="120" alt="展示会は新たな価値を見出す出会いの場" src="./images/topvisual.jpg" />
							</p>
							<div class="h2"><h2>詳細検索</h2></div>
							<div class="in_main">
								<table class="detail">
									<form name="form_fairListDetailSearch" id="form_fairListDetailSearch" method="post" action="">
									...
									<tr>
										<th>キーワード</th>
										<td>
											<input type="text" size="60" name="keyword" id="keyword" value="{$form.keyword}" /><br />
											<span class="small">展示会名・商品名（日本語）等</span>
										</td>
									</tr>
									<tr>
										<th>業種</th>
									...
									<tr>
										<th></th>
										<td>
											<input type="image" width="140" height="25" alt="検索" src="/j-messe/images/btn_search.gif" class="over" /></a>
