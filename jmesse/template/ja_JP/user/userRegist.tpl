...
<form>
<h4>ユーザーIDとパスワード</h4>
<p class="nomargin">J-messe見本市登録をご利用いただくためのユーザーIDとパスワードを設定してください。</p>
<table id="registration">
<tr>
<th class="item">ユーザーID</th>
<th class="required"><img src="/j-messe/images/db/required.gif" height="18" width="30" /></th>
<td><input type="text" value="" size="20" name="userid"><br />

<strong>半角英数小文字8文字以上、16文字以内で入力して下さい。</strong></td>
</tr>
<tr>
<th class="item">パスワード</th>
<th class="required"><img src="/j-messe/images/db/required.gif" height="18" width="30" /></th>
<td><input type="password" value="" size="20" name="password"><br />
<strong>半角英数小文字6文字以上、16文字以内で入力して下さい。</td>
</tr>
<tr>
<th class="item">パスワード（確認）</th>
<th class="required"><img src="/j-messe/images/db/required.gif" height="18" width="30" /></th>
<td><input type="password" value="" size="20" name="password2"><br />
...
<th class="required"><img src="/j-messe/images/db/required.gif" height="18" width="30" /></th>
<td><input type="text" value="" size="60" name="company"><br />
	</td>
</tr>
<tr>
<th class="item">部署名</th>
<th class="required"></th>
<td><input type="text" value="" size="60" name="section"><br />
	</td>
</tr>
<tr>
...
<th class="required"><img src="/j-messe/images/db/required.gif" height="18" width="30" /></th>
<td><input type="text" value="" size="50" name="email">
	</td>
</tr>
<tr>
<th class="item">Eメール（確認）</th>
<th class="required"><img src="/j-messe/images/db/required.gif" height="18" width="30" /></th>
<td><input type="text" value="" size="50" name="email2"><br />
...
<th class="required"></th>
<td>
<input type="text" maxlength="8" value="" size="10" name="postal">
（半角数字）<br />
...
<th class="item">住所</th>
<th class="required"><img src="/j-messe/images/db/required.gif" height="18" width="30" /></th>
<td><input type="text" value="" size="80" name="address"><br />
</td>
</tr>
<tr>
...
<th class="required"><img src="/j-messe/images/db/required.gif" height="18" width="30" /></th>
<td>
<input type="text" value="" size="30" name="tel"><br />
...
<th class="required"></th>
<td>
<input type="text" value="" size="30" name="fax"><br />
電話番号はハイフン区切りで国番号から入力してください。（半角数字）<br />
例：東京の場合　+81-3-1234-5678</td>
</tr>
</tr>
