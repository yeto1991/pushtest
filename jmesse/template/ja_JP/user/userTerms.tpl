							...
							<div class="in_main">
								...
								<form>
									...
									<ol class="terms">
										...
										<li><strong>見本市情報に関する責任</strong><br /> 日本及び各国・地域で開催される見本市情報を正確に提供するため、情報の掲載に先立ち、ジェトロは登録情報の内容を審査することがあります。ついては、登録情報が一般公開されるまで所定の時間を要しますので、予めご了承ください。<br /> <br /></li>

										<li><strong>掲載（一般公開）までにかかる時間</strong><br /> 本ウェブサイトにご登録いただく見本市情報のデータコンテンツ（情報、写真、データ等）に関する責任は、登録者本人が負うものとします。<br /> ジェトロは、ご登録いただいた見本市情報により利用者（登録者・閲覧者）に生じたいかなる損害に対しても、一切の責任を負いません。<br /> <br /></li>
