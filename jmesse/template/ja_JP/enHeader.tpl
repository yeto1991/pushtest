...
<script type="text/javascript" src="{$config.url_pub}js/j-messe/j-messe_en.js"></script>
<script type="text/javascript" src="{$config.url_pub}js/jquery/jquery.prettyPhoto.js" charset="utf-8"></script>
<script type="text/javascript" src="{$config.url_pub}js/jquery/jquery.tools.min.js"></script>
