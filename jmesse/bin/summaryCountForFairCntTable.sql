...
union all
select '002' as kbn_1, main_industory_1 as kbn_2, '000' as kbn_3, '000' as kbn_4, '' as venue_kbn, '0' as site_kbn, count(*) as fair_cnt from jm_fair where del_flg = '0' and confirm_flag = '1' and web_display_type = '1' and concat(date_to_yyyy, '/', date_to_mm, '/', date_to_dd) >= curdate() and select_language_info in ('0', '2') group by main_industory_1
union all
select '002' as kbn_1, main_industory_1 as kbn_2, '000' as kbn_3, '000' as kbn_4, '' as venue_kbn, '1' as site_kbn, count(*) as fair_cnt from jm_fair where del_flg = '0' and confirm_flag = '1' and web_display_type = '1' and concat(date_to_yyyy, '/', date_to_mm, '/', date_to_dd) >= curdate() and select_language_info in ('1', '2') group by main_industory_1
union all
select '002' as kbn_1, main_industory_2 as kbn_2, '000' as kbn_3, '000' as kbn_4, '' as venue_kbn, '0' as site_kbn, count(*) as fair_cnt from jm_fair where del_flg = '0' and confirm_flag = '1' and web_display_type = '1' and concat(date_to_yyyy, '/', date_to_mm, '/', date_to_dd) >= curdate() and main_industory_2 <> '' and main_industory_2 is not null and select_language_info in ('0', '2') group by main_industory_2
union all
select '002' as kbn_1, main_industory_2 as kbn_2, '000' as kbn_3, '000' as kbn_4, '' as venue_kbn, '1' as site_kbn, count(*) as fair_cnt from jm_fair where del_flg = '0' and confirm_flag = '1' and web_display_type = '1' and concat(date_to_yyyy, '/', date_to_mm, '/', date_to_dd) >= curdate() and main_industory_2 <> '' and main_industory_2 is not null and select_language_info in ('1', '2') group by main_industory_2
union all
