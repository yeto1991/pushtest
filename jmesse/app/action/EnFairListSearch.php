...
/**
 *  enFairListSearch Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Jmesse
 */
class Jmesse_Form_EnFairListSearch extends Jmesse_Form_EnFairList
{
}

/**
 *  enFairListSearch action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Jmesse
 */
class Jmesse_Action_EnFairListSearch extends Jmesse_ActionClass
{
	/**
	 *  preprocess of enFairListSearch Action.
	 *
	 *  @access public
	...
	function _paging() {
		...
		if (0 < $total) {
			...
			// ページャー作成
			$this->af->setAppNE('pager', $this->_makePager($this->config->get('url_pub').'?action_enFairListSearch=true&detail=1&page=', $page, $max_page));
			// 検索実行
