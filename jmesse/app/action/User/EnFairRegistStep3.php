...
/**
 *  user_enFairRegistStep3 Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Jmesse
 */
class Jmesse_Form_UserEnFairRegistStep3 extends Jmesse_Form_UserEnFairRegistStep1
{
}

/**
 *  user_enFairRegistStep3 action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Jmesse
 */
class Jmesse_Action_UserEnFairRegistStep3 extends Jmesse_ActionClass
{
	/**
	 *  preprocess of user_enFairRegistStep3 Action.
	 *
	 *  @access public
