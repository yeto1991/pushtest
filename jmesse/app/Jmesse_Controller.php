<?php
/**
 *  Jmesse_Controller.php
 *
 *  @author     {$author}
 *  @package    Jmesse
 *  @version    $Id: 29ef5e1659653000755c848776db8485ed9b60b0 $
 */
...
require_once 'Jmesse_Error.php';
require_once 'Jmesse_ActionClass.php';
require_once 'Jmesse_ActionForm.php';
require_once 'Jmesse_ViewClass.php';

/**
 *  Jmesse application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Jmesse
 */
class Jmesse_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
    ...
    var $class = array(
        ...
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Jmesse_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Jmesse_UrlHandler',
    );
