...
// 		"select jf.mihon_no id, jf.fair_title_jp name, concat(jf.date_from_yyyy, '年', jf.date_from_mm, '月', jf.date_from_dd, '日') start, concat(jf.date_to_yyyy, '年', jf.date_to_mm, '月', jf.date_to_dd, '日') end, co.discription_jp country, case when '' = jf.city then jf.other_city_jp else ci.discription_jp end city, jf.venue_jp site, jf.fair_url url from (select mihon_no, ranking_yyyymm, venue_kbn, access_cnt from jm_ranking where ranking_yyyymm = date_format(date_add(now(), interval - 2 month), '%Y%m') and venue_kbn = '1') jr inner join (select fair_title_jp, mihon_no, date_from_yyyy, date_from_mm, date_from_dd, date_to_yyyy, date_to_mm, date_to_dd, region, country, city, other_city_jp, venue_jp, fair_url from jm_fair where select_language_info in ('0', '2') and web_display_type = '1' and del_flg = '0' and confirm_flag = '1') jf on jr.mihon_no = jf.mihon_no left outer join (select kbn_2, kbn_3, discription_jp from jm_code_m where kbn_1 = '003' and kbn_4 = '000') co on jf.region = co.kbn_2 and jf.country = co.kbn_3 left outer join (select kbn_2, kbn_3, kbn_4, discription_jp from jm_code_m where kbn_1 = '003') ci on jf.region = ci.kbn_2 and jf.country = ci.kbn_3 and jf.city = ci.kbn_4 order by jr.access_cnt desc, jr.mihon_no desc limit 0, 10",
// 		"select jf.mihon_no id, jf.fair_title_jp name, concat(jf.date_from_yyyy, '年', jf.date_from_mm, '月', jf.date_from_dd, '日') start, concat(jf.date_to_yyyy, '年', jf.date_to_mm, '月', jf.date_to_dd, '日') end, co.discription_jp country, case when '' = jf.city then jf.other_city_jp else ci.discription_jp end city, jf.venue_jp site, jf.fair_url url from (select mihon_no, ranking_yyyymm, venue_kbn, access_cnt from jm_ranking where ranking_yyyymm = date_format(date_add(now(), interval - 3 month), '%Y%m') and venue_kbn = '1') jr inner join (select fair_title_jp, mihon_no, date_from_yyyy, date_from_mm, date_from_dd, date_to_yyyy, date_to_mm, date_to_dd, region, country, city, other_city_jp, venue_jp, fair_url from jm_fair where select_language_info in ('0', '2') and web_display_type = '1' and del_flg = '0' and confirm_flag = '1') jf on jr.mihon_no = jf.mihon_no left outer join (select kbn_2, kbn_3, discription_jp from jm_code_m where kbn_1 = '003' and kbn_4 = '000') co on jf.region = co.kbn_2 and jf.country = co.kbn_3 left outer join (select kbn_2, kbn_3, kbn_4, discription_jp from jm_code_m where kbn_1 = '003') ci on jf.region = ci.kbn_2 and jf.country = ci.kbn_3 and jf.city = ci.kbn_4 order by jr.access_cnt desc, jr.mihon_no desc limit 0, 10",
		"select jf.mihon_no mihon_no, jf.abbrev_title abbrev_title, jf.fair_title_en fair_title_en, jf.fair_title_en name, date_format(concat(jf.date_from_yyyy, '/', jf.date_from_mm, '/', jf.date_from_dd), '%b. %e, %Y') start, date_format(concat(jf.date_to_yyyy, '/', jf.date_to_mm, '/', jf.date_to_dd), '%b. %e, %Y') end, co.discription_en country, case when '' = jf.city then jf.other_city_en else ci.discription_en end city, jf.venue_en site, jr.venue_kbn, '1' site_kbn from (select mihon_no, ranking_yyyymm, venue_kbn, access_cnt from jm_ranking where ranking_yyyymm = date_format(date_add(now(), interval - 1 month), '%Y%m') and venue_kbn = '0') jr inner join (select mihon_no, abbrev_title, fair_title_en, date_from_yyyy, date_from_mm, date_from_dd, date_to_yyyy, date_to_mm, date_to_dd, region, country, city, other_city_en, venue_en from jm_fair where select_language_info in ('1', '2') and web_display_type = '1' and del_flg = '0' and confirm_flag = '1') jf on jr.mihon_no = jf.mihon_no left outer join (select kbn_2, kbn_3, discription_en from jm_code_m where kbn_1 = '003' and kbn_4 = '000') co on jf.region = co.kbn_2 and jf.country = co.kbn_3 left outer join (select kbn_2, kbn_3, kbn_4, discription_en from jm_code_m where kbn_1 = '003') ci on jf.region = ci.kbn_2 and jf.country = ci.kbn_3 and jf.city = ci.kbn_4 order by jr.access_cnt desc, jr.mihon_no desc limit 0, 10",
		"select jf.mihon_no mihon_no, jf.abbrev_title abbrev_title, jf.fair_title_en fair_title_en, jf.fair_title_en name, date_format(concat(jf.date_from_yyyy, '/', jf.date_from_mm, '/', jf.date_from_dd), '%b. %e, %Y') start, date_format(concat(jf.date_to_yyyy, '/', jf.date_to_mm, '/', jf.date_to_dd), '%b. %e, %Y') end, co.discription_en country, case when '' = jf.city then jf.other_city_en else ci.discription_en end city, jf.venue_en site, jr.venue_kbn, '1' site_kbn from (select mihon_no, ranking_yyyymm, venue_kbn, access_cnt from jm_ranking where ranking_yyyymm = date_format(date_add(now(), interval - 2 month), '%Y%m') and venue_kbn = '0') jr inner join (select mihon_no, abbrev_title, fair_title_en, date_from_yyyy, date_from_mm, date_from_dd, date_to_yyyy, date_to_mm, date_to_dd, region, country, city, other_city_en, venue_en from jm_fair where select_language_info in ('1', '2') and web_display_type = '1' and del_flg = '0' and confirm_flag = '1') jf on jr.mihon_no = jf.mihon_no left outer join (select kbn_2, kbn_3, discription_en from jm_code_m where kbn_1 = '003' and kbn_4 = '000') co on jf.region = co.kbn_2 and jf.country = co.kbn_3 left outer join (select kbn_2, kbn_3, kbn_4, discription_en from jm_code_m where kbn_1 = '003') ci on jf.region = ci.kbn_2 and jf.country = ci.kbn_3 and jf.city = ci.kbn_4 order by jr.access_cnt desc, jr.mihon_no desc limit 0, 10",
		"select jf.mihon_no mihon_no, jf.abbrev_title abbrev_title, jf.fair_title_en fair_title_en, jf.fair_title_en name, date_format(concat(jf.date_from_yyyy, '/', jf.date_from_mm, '/', jf.date_from_dd), '%b. %e, %Y') start, date_format(concat(jf.date_to_yyyy, '/', jf.date_to_mm, '/', jf.date_to_dd), '%b. %e, %Y') end, co.discription_en country, case when '' = jf.city then jf.other_city_en else ci.discription_en end city, jf.venue_en site, jr.venue_kbn, '1' site_kbn from (select mihon_no, ranking_yyyymm, venue_kbn, access_cnt from jm_ranking where ranking_yyyymm = date_format(date_add(now(), interval - 3 month), '%Y%m') and venue_kbn = '0') jr inner join (select mihon_no, abbrev_title, fair_title_en, date_from_yyyy, date_from_mm, date_from_dd, date_to_yyyy, date_to_mm, date_to_dd, region, country, city, other_city_en, venue_en from jm_fair where select_language_info in ('1', '2') and web_display_type = '1' and del_flg = '0' and confirm_flag = '1') jf on jr.mihon_no = jf.mihon_no left outer join (select kbn_2, kbn_3, discription_en from jm_code_m where kbn_1 = '003' and kbn_4 = '000') co on jf.region = co.kbn_2 and jf.country = co.kbn_3 left outer join (select kbn_2, kbn_3, kbn_4, discription_en from jm_code_m where kbn_1 = '003') ci on jf.region = ci.kbn_2 and jf.country = ci.kbn_3 and jf.city = ci.kbn_4 order by jr.access_cnt desc, jr.mihon_no desc limit 0, 10",
// 		"select jf.mihon_no id, jf.fair_title_en name, concat(jf.date_from_yyyy, '年', jf.date_from_mm, '月', jf.date_from_dd, '日') start, concat(jf.date_to_yyyy, '年', jf.date_to_mm, '月', jf.date_to_dd, '日') end, co.discription_en country, case when '' = jf.city then jf.other_city_en else ci.discription_en end city, jf.venue_en site, jf.fair_url url from (select mihon_no, ranking_yyyymm, venue_kbn, access_cnt from jm_ranking where ranking_yyyymm = date_format(date_add(now(), interval - 1 month), '%Y%m') and venue_kbn = '0') jr inner join (select fair_title_en, mihon_no, date_from_yyyy, date_from_mm, date_from_dd, date_to_yyyy, date_to_mm, date_to_dd, region, country, city, other_city_en, venue_en, fair_url from jm_fair where select_language_info in ('1', '2') and web_display_type = '1' and del_flg = '0' and confirm_flag = '1') jf on jr.mihon_no = jf.mihon_no left outer join (select kbn_2, kbn_3, discription_en from jm_code_m where kbn_1 = '003' and kbn_4 = '000') co on jf.region = co.kbn_2 and jf.country = co.kbn_3 left outer join (select kbn_2, kbn_3, kbn_4, discription_en from jm_code_m where kbn_1 = '003') ci on jf.region = ci.kbn_2 and jf.country = ci.kbn_3 and jf.city = ci.kbn_4 order by jr.access_cnt desc, jr.mihon_no desc limit 0, 10",
// 		"select jf.mihon_no id, jf.fair_title_en name, concat(jf.date_from_yyyy, '年', jf.date_from_mm, '月', jf.date_from_dd, '日') start, concat(jf.date_to_yyyy, '年', jf.date_to_mm, '月', jf.date_to_dd, '日') end, co.discription_en country, case when '' = jf.city then jf.other_city_en else ci.discription_en end city, jf.venue_en site, jf.fair_url url from (select mihon_no, ranking_yyyymm, venue_kbn, access_cnt from jm_ranking where ranking_yyyymm = date_format(date_add(now(), interval - 2 month), '%Y%m') and venue_kbn = '0') jr inner join (select fair_title_en, mihon_no, date_from_yyyy, date_from_mm, date_from_dd, date_to_yyyy, date_to_mm, date_to_dd, region, country, city, other_city_en, venue_en, fair_url from jm_fair where select_language_info in ('1', '2') and web_display_type = '1' and del_flg = '0' and confirm_flag = '1') jf on jr.mihon_no = jf.mihon_no left outer join (select kbn_2, kbn_3, discription_en from jm_code_m where kbn_1 = '003' and kbn_4 = '000') co on jf.region = co.kbn_2 and jf.country = co.kbn_3 left outer join (select kbn_2, kbn_3, kbn_4, discription_en from jm_code_m where kbn_1 = '003') ci on jf.region = ci.kbn_2 and jf.country = ci.kbn_3 and jf.city = ci.kbn_4 order by jr.access_cnt desc, jr.mihon_no desc limit 0, 10",
// 		"select jf.mihon_no id, jf.fair_title_en name, concat(jf.date_from_yyyy, '年', jf.date_from_mm, '月', jf.date_from_dd, '日') start, concat(jf.date_to_yyyy, '年', jf.date_to_mm, '月', jf.date_to_dd, '日') end, co.discription_en country, case when '' = jf.city then jf.other_city_en else ci.discription_en end city, jf.venue_en site, jf.fair_url url from (select mihon_no, ranking_yyyymm, venue_kbn, access_cnt from jm_ranking where ranking_yyyymm = date_format(date_add(now(), interval - 3 month), '%Y%m') and venue_kbn = '0') jr inner join (select fair_title_en, mihon_no, date_from_yyyy, date_from_mm, date_from_dd, date_to_yyyy, date_to_mm, date_to_dd, region, country, city, other_city_en, venue_en, fair_url from jm_fair where select_language_info in ('1', '2') and web_display_type = '1' and del_flg = '0' and confirm_flag = '1') jf on jr.mihon_no = jf.mihon_no left outer join (select kbn_2, kbn_3, discription_en from jm_code_m where kbn_1 = '003' and kbn_4 = '000') co on jf.region = co.kbn_2 and jf.country = co.kbn_3 left outer join (select kbn_2, kbn_3, kbn_4, discription_en from jm_code_m where kbn_1 = '003') ci on jf.region = ci.kbn_2 and jf.country = ci.kbn_3 and jf.city = ci.kbn_4 order by jr.access_cnt desc, jr.mihon_no desc limit 0, 10",
		"select jf.mihon_no mihon_no, jf.abbrev_title abbrev_title, jf.fair_title_en fair_title_en, jf.fair_title_en name, date_format(concat(jf.date_from_yyyy, '/', jf.date_from_mm, '/', jf.date_from_dd), '%b. %e, %Y') start, date_format(concat(jf.date_to_yyyy, '/', jf.date_to_mm, '/', jf.date_to_dd), '%b. %e, %Y') end, co.discription_en country, case when '' = jf.city then jf.other_city_en else ci.discription_en end city, jf.venue_en site, jr.venue_kbn, '1' site_kbn from (select mihon_no, ranking_yyyymm, venue_kbn, access_cnt from jm_ranking where ranking_yyyymm = date_format(date_add(now(), interval - 1 month), '%Y%m') and venue_kbn = '1') jr inner join (select mihon_no, abbrev_title, fair_title_en, date_from_yyyy, date_from_mm, date_from_dd, date_to_yyyy, date_to_mm, date_to_dd, region, country, city, other_city_en, venue_en from jm_fair where select_language_info in ('1', '2') and web_display_type = '1' and del_flg = '0' and confirm_flag = '1') jf on jr.mihon_no = jf.mihon_no left outer join (select kbn_2, kbn_3, discription_en from jm_code_m where kbn_1 = '003' and kbn_4 = '000') co on jf.region = co.kbn_2 and jf.country = co.kbn_3 left outer join (select kbn_2, kbn_3, kbn_4, discription_en from jm_code_m where kbn_1 = '003') ci on jf.region = ci.kbn_2 and jf.country = ci.kbn_3 and jf.city = ci.kbn_4 order by jr.access_cnt desc, jr.mihon_no desc limit 0, 10",
		"select jf.mihon_no mihon_no, jf.abbrev_title abbrev_title, jf.fair_title_en fair_title_en, jf.fair_title_en name, date_format(concat(jf.date_from_yyyy, '/', jf.date_from_mm, '/', jf.date_from_dd), '%b. %e, %Y') start, date_format(concat(jf.date_to_yyyy, '/', jf.date_to_mm, '/', jf.date_to_dd), '%b. %e, %Y') end, co.discription_en country, case when '' = jf.city then jf.other_city_en else ci.discription_en end city, jf.venue_en site, jr.venue_kbn, '1' site_kbn from (select mihon_no, ranking_yyyymm, venue_kbn, access_cnt from jm_ranking where ranking_yyyymm = date_format(date_add(now(), interval - 2 month), '%Y%m') and venue_kbn = '1') jr inner join (select mihon_no, abbrev_title, fair_title_en, date_from_yyyy, date_from_mm, date_from_dd, date_to_yyyy, date_to_mm, date_to_dd, region, country, city, other_city_en, venue_en from jm_fair where select_language_info in ('1', '2') and web_display_type = '1' and del_flg = '0' and confirm_flag = '1') jf on jr.mihon_no = jf.mihon_no left outer join (select kbn_2, kbn_3, discription_en from jm_code_m where kbn_1 = '003' and kbn_4 = '000') co on jf.region = co.kbn_2 and jf.country = co.kbn_3 left outer join (select kbn_2, kbn_3, kbn_4, discription_en from jm_code_m where kbn_1 = '003') ci on jf.region = ci.kbn_2 and jf.country = ci.kbn_3 and jf.city = ci.kbn_4 order by jr.access_cnt desc, jr.mihon_no desc limit 0, 10",
